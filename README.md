...
![Deps.rs Crate Dependencies (specific version)](https://img.shields.io/deps-rs/little_weirdo/0.1.4)
![docs.rs (with version)](https://img.shields.io/docsrs/little_weirdo/0.1.4?style=flat)
