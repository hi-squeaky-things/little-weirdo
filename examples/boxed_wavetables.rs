...
use cpal::Sample;
use little_weirdo::synth::{self, data::wavetables::SoundBank, patch::Patch};
...
fn main() {
    ...
    let mut writer = hound::WavWriter::create("boxed_osc_test.wav", spec).unwrap();
    ...
    synth::Synth::new(SAMPLE_RATE as u16, patch, wt.wavetables);
